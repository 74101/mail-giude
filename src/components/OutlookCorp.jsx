...
export const OutlookCorp = () => {
	return (
		<>
			<h1 className="sticky top-0 -mx-5 -my-4 px-5 py-4 text-3xl font-bold mb-2 bg-neutral-800/80">Microsoft Outlook (Corp.uz)</h1>
			<ol className="list-decimal pl-6 text-lg">
				...
				<li className="mb-6">
					<p className="mb-2">Введите адрес электронной почты.
						...
						подключить.</p>
					<img className="rounded-lg overflow-hidden shadow-lg shadow-emerald-800/20" src="/images/outlook_corp/OUTLOOK_corp_manually.jpg" alt="адрес электронной почты"/>
				</li>
				<li className="mb-6">
				...
				<li className="mb-6">
					...
					<h3 className="mb-2">Для IMAP:</h3>
					<img className="rounded-lg overflow-hidden shadow-lg shadow-emerald-800/20" src="/images/outlook_corp/OUTLOOK_corp_imap_done.jpg" alt="IMAP успешно добавлена"/>
					<h3 className="mb-2 mt-4">Для POP3:</h3>
					<img className="rounded-lg overflow-hidden shadow-lg shadow-emerald-800/20" src="/images/outlook_corp/OUTLOOK_corp_pop_done.jpg" alt="POP3 успешно добавлена"/>
				</li>
			</ol>
		</>
	)
